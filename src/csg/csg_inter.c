...
/*   Updated: 2019/05/10 20:09:08 by roduquen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	csg_inter_utils(t_ray_hit hit1, t_ray_hit hit2, t_ray_hit *hit)
{
	hit->dist = hit1.dist;
...
static void	csg_inter_func_2(t_ray_hit hit1, t_ray_hit hit2, t_ray_hit *hit)
{
...
static void	csg_inter_func_3(t_ray_hit hit1, t_ray_hit hit2, t_ray_hit *hit)
{
...
void		csg_inter_func(t_ray_hit hit1, t_ray_hit hit2, t_ray_hit *hit)
{
	if (hit1.dist <= 0 || hit2.dist <= 0)
	{
		...
		csg_inter_func_2(hit1, hit2, hit);
	else
	{
		if (hit2.dist == hit2.dist_b)
		{
			...
			csg_inter_func_3(hit1, hit2, hit);
	}
}
